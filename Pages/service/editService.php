...
<html lang="en">
    <head>
        ...
        <title>Edit Service - SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4"> Edit Service </h2>
      </div>
      <div class="col-md-8 order-md-1" role="form" >
          ...
          <form class="needs-validation" validate enctype="multipart/form-data" method="post" action="../../formSubmission.php">
            ...
            <div>   
                ...
                (Will keep the old service photo if it is leave empty)
            </div>
             <div>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <label  class="form-label">About the Service</label>
               <textarea rows="8"class="form-control " id="exampleFormControlTextarea1"rows="8" name="text" require minlength="20" maxlength="150" ><?= $_GET['text'] ?></textarea>
               <div class="invalid-feedback">
                ...
                <div>
             <input type="checkbox" name="status" <?= ($_GET['status'] == 1 ) ? "checked" : "" ?>> Active Service
      
            <hr class="mb-4">

            <input class="btn btn-success btn-lg btn-block" type="submit" value="Save Service" name="submit">
