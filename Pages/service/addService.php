...
<html lang="en">
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4"> Add Service: </h2>
        <p class="lead">Complete the form to add new service.</p>
      </div>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <div class="mb-3">
               ...
               <textarea rows="8" class="form-control" id="exampleFormControlTextarea1" rows="3" name="text" require minlength="20" maxlength="150"></textarea>
            ...
            <input class="btn btn-primary btn-lg btn-block" type="submit" value="Add Service" name="submit">
