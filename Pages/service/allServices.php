...
<html lang="en">
    ...
    <body  id="body-users">
      ...
      <div class="table-responsive-sm">
        <h3 class="display-4" >Service Management</h3>
        <br/>
     <a href="addService.php"><button type="submit" class="btn btn-primary">Add <i class="fas fa-plus"></i> </button></a>
      <br/>
      <br/>
    ...
    <table class="table table-dark table-striped" id="table-users">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src='<?= "../../" . $service->getImage() ?>' style="width: 200px;height: 150px;"></td>
          <td width="20%"><?= $service->getTitle() ?></td>
          <td class="text-wrap">
          ...
          <a  href="editService.php?title=<?=$service->getTitle()?>&image=<?=$service->getImage()?>&text=<?=$service->getText()?>&id=<?=$service->getId()?>&status=<?=$service->getStatus()?>"><button type="submit" class="btn btn-success"><i class="fas fa-edit" ></i></button></a> 
          <?php if($_SESSION['user']->getLevel() == 1 ): ?>
           <a  href="deleteService.php?title=<?=$service->getTitle()?>&image=<?=$service->getImage()?>&text=<?=$service->getText()?>&id=<?=$service->getId()?>"><button type="submit" class="btn btn-danger"><i class="far fa-trash-alt"></i></button> </a> 
          <?php endif;?>
