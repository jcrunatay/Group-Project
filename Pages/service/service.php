...
<html lang="en">
    ...
    <body  id="body-users">
        ...
        <p class="lead">Below is the option to change your service text and image or style of the text.</p>
      </div>
             ...
             <label for="exampleFormControlTextarea1" class="form-label">First text</label>
               ...
               <div class="invalid-feedback">
                  Valid first service is required.
                        ...
                        <!--  SLIDER TEXT #2  -->
              <div class="mb-3">
             <label for="exampleFormControlTextarea1" class="form-label">Middle text</label>
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
               <div class="invalid-feedback">
                  Valid middle text is required.
                </div>
                </div>
          
                <div>
                 <!--  SLIDER #1 PICTURE -->
                <label for="formFileLg" class="form-label">Picture Slider #1</label>
                    <input class="form-control form-control-lg" id="formFileLg" type="file">
                   </div>
                   <div>
                         <!--  SLIDER #2 PICTURE -->
                <label for="formFileLg" class="form-label">Picture Slider #2</label>
                    <input class="form-control form-control-lg" id="formFileLg" type="file">
                   </div>
                   <div>
                              <!--  SLIDER #3 PICTURE -->
                <label for="formFileLg" class="form-label">Picture Slider #3</label>
                    <input class="form-control form-control-lg" id="formFileLg" type="file">
                   </div>
    <!--  FORM FOR THE SLIDER -->
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Welcome Text</h4>
          <form class="needs-validation" validate>
            <div class="row">
               <!--  SLIDER TEXT #1  -->
                  <div class="mb-3">
