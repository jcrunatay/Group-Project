...
<html lang="en">
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4"> Header Slider</h2>
        <div class="container">
            <br><br>

            <?php if(!empty($sliderImages)) : ?>            
            <div class="row mt-4">
            <h4 class="mb-3 display-6 text-start">Current Slide Images </h4>
            <hr class="mb-4">
               <?php for ($i = 0; $i < count($sliderImages); $i++) : ?>
                    <div class="my-2 mx-2" style="width:350px;height:250px;"><img src="<?= "../../" . $sliderImages[$i]?>" style="width: 100%;height: 100%;"></div>
               <?php endfor; ?>
            </div>
             <?php endif ?>
            <br><br>
            ...
            <h4 class="mb-3 display-6 text-start">Update Slide Images</h4>
            <hr class="mb-4">
            ...
            <!--   Slider Image -->
             <div class="col-6 mb-3">
               <label for="exampleFormControlInput3" class="form-label  float-start">Image 1</label>
               <input type="file" class="form-control" id="exampleFormControlInput3" name="slider1" accept="image/*" required> 
             </div>

             <div class="col-6 mb-3">
               <label for="exampleFormControlInput3" class="form-label float-start">Image 2</label>
               <input type="file" class="form-control" id="exampleFormControlInput3" name="slider2" accept="image/*" required> 
             </div>
             <div class="col-6 mb-3">
               <label for="exampleFormControlInput3" class="form-label float-start">Image 3</label>
               <input type="file" class="form-control" id="exampleFormControlInput3" name="slider3" accept="image/*" required> 
             </div>
             <br>
            <input class="btn btn-success btn-lg btn-block float-start" type="submit" value="Save Slider Images" name="submit">
             <br>
            </form>
