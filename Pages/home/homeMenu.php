...
<html lang="en">
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4">Home Config</h2>

        <br><br>

        <div class="row justify-content-center mt-5 homeMenuRow">
    
        <div class="card mx-4 my-2 bg-white py-3 shadow-lg" style="width: 20rem;">
              <img class="card-img-top mx-auto" src="./img/welcome.png" alt="Card image cap" style="max-width: 70%;height: 200px;">
              <div class="card-body">
                <h5 class="card-title">Page Content</h5>
                <p class="card-text"> Header, About, Contact Sections.</p>
                <a href="./headerContent.php" class="btn btn-primary">Proceed</a>
              </div>     
        </div>


        <div class="card mx-4 my-2  bg-white py-3 shadow-lg" style="width: 20rem;">
              <img class="card-img-top mx-auto" src="./img/slider.png" alt="Card image cap" style="max-width: 70%;height: 200px;">
              <div class="card-body">
                <h5 class="card-title">Slider</h5>
                <p class="card-text"> Update Header Images.</p>
                <a href="./slider.php" class="btn btn-primary">Proceed</a>
              </div>
        </div>

        <div class="card mx-4 my-2 bg-white shadow-lg py-3" style="width: 20rem;">
              <img class="card-img-top mx-auto" src="./img/footer.png" alt="Card image cap" style="max-width: 70%;height: 200px;">
              <div class="card-body">
                <h5 class="card-title">Social Media</h5>
                <p class="card-text">Company's Social Networks.</p>
                <a href="../contact/social_media.php" class="btn btn-primary">Proceed</a>
              </div>
        </div>
