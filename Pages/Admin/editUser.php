    ...
    <!--  FORM FOR THE contact -->
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" validate action="../../formSubmission.php" method="POST">
             ...
             <input type="text" class="form-control" id="exampleFormControlInput1" value="<?=$_GET['username']?>" name="username" minlength="7" maxlength="30" required>
                </div>
            ...
            <!--   Name -->
             ...
             <input type="text" class="form-control" id="exampleFormControlInput2" value="<?=$_GET['name']?>" name="name" minlength="2" maxlength="30" required>
                </div>
            ...
            <!--   Email -->
             ...
             <input type="email" class="form-control" id="exampleFormControlInput3"  name="email" value="<?=$_GET['email']?>" minlength="10" maxlength="50" required>
                </div>
            ...
            <!--   Password -->
            <div class="col-8 mb-3">
               <label for="exampleFormControlInput4" class="form-label">New Password (Will keep the current password if empty)</label>
             ...
             <div class="col-8 mb-3">
             <input type="checkbox" name="level" <?= ($_GET['level'] == 1 ) ? "checked" : ""?> > Admin
             </div>

             <div class="col-8 mb-3">
             <input type="checkbox" name="status" <?= ($_GET['status'] == 1 ) ? "checked" : ""?>> Active User
             </div>
            ...
            <hr class="mb-4">
             <input class="btn btn-success btn-lg btn-block" type="submit" value="Save User" name="submit">
