...
<html lang="en">
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4">New Account:</h2>
        <p class="lead">Complete the form to register a new user</p>
      </div>
    <!--  FORM FOR THE contact -->
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" validate action="../../formSubmission.php" method="POST">
             ...
             <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="username" minlength="7" maxlength="30" required>
                </div>
            ...
            <!--   Name -->
             ...
             <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="" name="name" minlength="2" maxlength="30" required>
                </div>
            ...
            <!--   Email -->
             ...
             <input type="email" class="form-control" id="exampleFormControlInput3" placeholder="" name="email" minlength="10" maxlength="50" required>
                </div>
             ...
             <input type="password" class="form-control" id="exampleFormControlInput4" placeholder="********" name="password" minlength="7" maxlength="30" required>
                </div>

             <!--  Confirmation  Password -->
             <div class="mb-3">
               <label for="exampleFormControlInput5" class="form-label">Confirmation Password </label>
             <input type="password" class="form-control" id="exampleFormControlInput5" placeholder="*********" name="passConfirm" minlength="7" maxlength="30" required> 
             </div>
            ...
            <hr class="mb-4">
             <input class="btn btn-primary btn-lg btn-block" type="submit" value="Add User" name="submit">
