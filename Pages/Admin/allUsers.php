...
<html lang="en">
    <head>
        ...
        <title>All Users - SB Admin</title>
    ...
    <body  id="body-users">
      ...
      <div class="table-responsive-sm">
        ...
        <br/>
     <a href="addUser.php"><button type="submit" class="btn btn-primary">Add <i class="fas fa-plus"></i></button></a>
      <br/>
      <br/>
    ...
    <br>
    <table class="table table-dark " id="table-users">
      <thead>
        <tr>
          <th scope="col">#</th>
      ...
      <tbody>
        ...
        <tr>
         ...
         <a href="editUser.php?username=<?=$user->getUsername()?>&email=<?=$user->getEmail()?>&name=<?=$user->getName()?>&id=<?=$user->getId()?>&level=<?=$user->getLevel()?>&status=<?=$user->getStatus()?>"><button type="submit" class="btn btn-success"><i class="fas fa-edit" ></i></button></a>

          <a href="deleteUser.php?username=<?=$user->getUsername()?>&email=<?=$user->getEmail()?>&name=<?=$user->getName()?>&id=<?=$user->getId()?>&level=<?=$user->getLevel()?>"><button type="submit" class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
