...
<html lang="en">
    <head>
        ...
        <title>Edit Member - SB Admin</title>
    ...
    <body  id="body-users">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                           ...
                           <?php endif;?>
                            ...
                            <a class="nav-link" href="allTeamMembers.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                Team
                            </a>
        ...
        <h2 class="display-4" >Edit Team Member </h2>
      ...
      <form class="needs-validation" validate  enctype="multipart/form-data" method="post" action="../../formSubmission.php">
          <!--h4 class="mb-3">Picture </h4-->
            ...
            <div>
                ...
                <input class="form-control form-control-md"  type="text" name="name"  required minlength="2" maxlength="50" value="<?= $_GET['name'] ?>" >
            </div>
             <div><br>
          ...
          <input type="text" class="form-control" id="exampleFormControlInput1" name="title" required minlength="2" maxlength="30" value="<?= $_GET['title']?>" >
            </div>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <div class="mb-3">
               ...
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" name="text" required minlength="15" maxlength="150" ><?= $_GET['text']?></textarea>
             ...
             <input type="checkbox" name="status" <?= ($_GET['status'] == 1 ) ? "checked" : "" ?>> Active Team Member

            <hr class="mb-4">

            <input class="btn btn btn-success btn-lg btn-block" type="submit" value="Save Team Member" name="submit">
            <a class="btn btn-warning btn-lg btn-block" href="allTeamMembers.php"> Cancel </a>
            </form>
            <br>
