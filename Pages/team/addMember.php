...
<html lang="en">
    <head>
        ...
        <title>Add Member - SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <p class="lead">Complete the form to add new member in the team</p>
      </div>
      ...
      <form class="needs-validation" validate  enctype="multipart/form-data" method="post" action="../../formSubmission.php">
          <!--h4 class="mb-3">Picture </h4-->
            ...
            <div>
                ...
                <input class="form-control form-control-md"  type="text" name="name" required minlength="2" maxlength="50">
            </div>
             <div><br>
          ...
          <input type="text" class=" form-control" id="exampleFormControlInput1" name="title" required minlength="2" maxlength="30">
            </div>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <div class="mb-12">
               ...
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" name="text" required minlength="15" maxlength="150"></textarea>
            ...
            <input class="btn btn btn-primary btn-lg btn-block" type="submit" value="Add Team Member" name="submit">
