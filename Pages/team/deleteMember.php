...
<html lang="en">
    <head>
        ...
        <title>Delete Member - SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4" >Delete Team Member </h2>
      ...
      <form class="needs-validation" validate  enctype="multipart/form-data" method="post" action="../../formSubmission.php">
          <!--h4 class="mb-3">Picture </h4-->
            ...
            <!--  #1 PICTURE -->
                <label  class="form-label">Teamm Member Image</label><br>
            ...
            <div>
                ...
                <input class="form-control form-control-md"  type="text" name="name" value="<?= $_GET['name'] ?>" readonly>
            </div>
             <div><br>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <div class="mb-3">
               ...
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" name="text" readonly><?= $_GET['text']?></textarea>
            ...
            <input class="btn btn btn-danger btn-lg btn-block" type="submit" value="Delete Team Member" name="submit" onclick="return confirm('Are you sure you want to delete <?= $_GET['name'] ?> ?')">
