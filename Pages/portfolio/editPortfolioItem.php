...
<html lang="en">
    <head>
        ...
        <title>Edit Portfoilio Item - SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4">Edit Portfolio Item </h2>
      </div>
      <div class="col-md-8 order-md-1" role="form" >
          ...
          <form class="needs-validation" validate enctype="multipart/form-data" method="post" action="../../formSubmission.php" >
            ...
            <div>   
                 <!--  #1 PICTURE -->
                <label  class="form-label">Project Item Image</label>
                <input class="form-control form-control-md" id="formFileLg" type="file" name="image" accept="image/*">
                (Will keep the old portfolio image photo if it is leave empty)
                   </div>
                   <div>
          ...
          <input type="text" class="form-control" id="exampleFormControlInput1" name="title" required minlength="5" maxlength="30" value="<?= $_GET['title']?>">
             </div>
        ...
        <div class="col-md-8 order-md-1">
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              <!-- TEXT #1  -->
              <div class="mb-3">
                <label  class="form-label">About the Portfolio Item</label>
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" name="text" require minlength="20" maxlength="150"><?= $_GET['text'] ?></textarea>
            ...
            <input type="checkbox" name="status" <?= ($_GET['status'] == 1 ) ? "checked" : "" ?>> Active Portfolio Item

            <hr class="mb-4">

            <input class="btn btn-success btn-lg btn-block" type="submit" value="Save Portfolio Item" name="submit" >
            <a class="btn btn-warning btn-lg btn-block" href="portfolio.php"> Cancel </a>
