...
<html lang="en">
    <head>
        ...
        <title>Delete Portfolio Item- SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4"> Delete Portfolio Item </h2>
      </div>
      <div class="col-md-8 order-md-1" role="form" >
          ...
          <form class="needs-validation" validate enctype="multipart/form-data" method="post" action="../../formSubmission.php">
            ...
            <div>   
                 <!--  #1 PICTURE -->
                <label  class="form-label">Portfolio Item Image</label><br>
        ...
        <div class="col-md-8 order-md-1">
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              <!-- TEXT #1  -->
              <div class="mb-3" >
              <label  class="form-label">About Portfolio Item</label>
            ...
            <input class="btn btn-danger btn-lg btn-block" type="submit" value="Delete Portfolio Item" name="submit" onclick="return confirm('Are you sure you want to delete the item ?')">
