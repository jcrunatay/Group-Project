...
<html lang="en">
    <head>
        ...
        <title>Add Portfoilio Item - SB Admin</title>
    ...
    <body  id="body-users">
        ...
        <h2 class="display-4">Add Portfolio Item: </h2>
        <p class="lead">Complete the form to add new portfolio item.</p>
      </div>
      <div class="col-md-8 order-md-1" role="form" >
          ...
          <form class="needs-validation" validate enctype="multipart/form-data" method="post" action="../../formSubmission.php" >
            ...
            <div>   
                 <!--  #1 PICTURE -->
                <label  class="form-label">Portfolio Item Image</label>
                <input class="form-control form-control-md" id="formFileLg" type="file" name="image" required accept="image/*">
                   </div>
                   <div>
          ...
          <input type="text" class="form-control" id="exampleFormControlInput1" name="title" required minlength="5" maxlength="30">
             </div>
          ...
          <!--h4 class="mb-3">Text</h4-->
            <div class="row">
              ...
              <div class="mb-3">
               ...
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="8" name="text" require minlength="20" maxlength="150"></textarea>
            ...
            <input class="btn btn-primary btn-lg btn-block" type="submit" value="Add Portfolio Item" name="submit" >
