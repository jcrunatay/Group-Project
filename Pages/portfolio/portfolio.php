...
<html lang="en">
    <head>
        ...
        <title>All Services - SB Admin</title>
    ...
    <body  id="body-users">
      ...
      <div class="table-responsive-sm">
        <h3 class="display-4">Portfolio Management</h3>
        <br/>
     <a href="addPortfolioItem.php"><button type="submit" class="btn btn-primary">Add <i class="fas fa-plus"></i> </button></a>
      <br/>
      <br/>
    ...
    <table class="table table-dark table-striped" id="table-users">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src='<?= "../../" . $portfolioItem->getImage() ?>' style="width: 200px;height: 150px;"></td>
          <td width="20%"><?= $portfolioItem->getTitle() ?></td>
          <td class="text-wrap">
                <!-- TEXTWRAP IT SO THAT IF LONG TEXT IS PRINTED, IT WONT RUIN  THE TABLE-->
                <div class="text-wrap">
                 <?= $portfolioItem->getText()?>
                </div>
          </td>
          <td width="10%">
           <!--button type="submit" class="btn btn-success" ><i class="fas fa-edit" ></i></button-->
            <a  href="editPortfolioItem.php?title=<?=$portfolioItem->getTitle()?>&image=<?=$portfolioItem->getImage()?>&text=<?=$portfolioItem->getText()?>&id=<?=$portfolioItem->getId()?>&status=<?=$portfolioItem->getStatus()?>"><button type="submit" class="btn btn-success"><i class="fas fa-edit" ></i></button></a> 
           <?php if($_SESSION['user']->getLevel() == 1 ) : ?>
           <a  href="deletePortfolioItem.php?title=<?=$portfolioItem->getTitle()?>&image=<?=$portfolioItem->getImage()?>&text=<?=$portfolioItem->getText()?>&id=<?=$portfolioItem->getId()?>"><button type="submit" class="btn btn-danger"><i class="far fa-trash-alt"></i></button><a/>
            <?php endif; ?>
          </td>
        </tr>
